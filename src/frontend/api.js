...
const API = {
    ...
    me: (options = {}) => apiRequest('/me', 'GET', null, options),
    getUsers: (options = {}) => apiRequest('/users', 'GET', null, options),
    ...
    // Notifications
    getNotifications: (options = {}) => apiRequest('/notifications', 'GET', null, options),
